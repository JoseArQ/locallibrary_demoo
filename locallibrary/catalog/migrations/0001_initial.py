# Generated by Django 3.2.2 on 2021-05-09 22:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='ingrese breve descripción del libro', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='ingrese el nombre del genero (p. ej. Ciencia Ficción, Poesía etc)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
